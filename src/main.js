...
$(document).ready(function() {
    setTimeout(() => {
        $chatBox.append(`<p class="bot-message"><strong>Camu Bot:</strong> ¡Hola! Soy tu asistente de IA para el sistema de monitoreo de presión de gas. Puedo ayudarte con información sobre linepack, autonomía y recomendaciones para mantener el sistema operando de manera óptima. ¿En qué puedo ayudarte hoy?</p>`);
    }, 500);
});